...
import { garantirUidUsuario, salvarPerfil, getPerfil, uploadImagemCloudinary } from "../services/perfilService.js";
import { setButtonLoading, showToast } from "../scripts/utils.js";
...
function preencherFormulario(perfil, authUser, uidUsuario) {
  ...
  if (previewFoto) {
    previewFoto.src = perfil?.fotoURL || "../assets/fotos/larva.jpeg";
  }
